...
A: To solve naked twin strategy we iterate through each unit and identify the pair of boxes having same 2 digits within same unit. On finding such boxes we eliminate the 2 digits from all others boxes of the unit. This reduces the number of options for other boxes.

# Question 2 (Diagonal Sudoku)
Q: How do we use constraint propagation to solve the diagonal sudoku problem?  
A: To solve the diagonal sudoku we add diagonal units to the unit list. by adding the diagonal to unit list, we ensure when checking eliminate and only choice we include diagonals also along with rows, columns,same 3x3 square checks.
=======
## Synopsis
...
>>>>>>> cce864681732bb107b9dfbd8b9a7f071e3ddf301
